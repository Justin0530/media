        ...
        <div class="span12">
            <div class="widget-box">
                ...
                <div class="widget-content nopadding">
                    {{ Form::open(array('url' =>
                    URL::to('menu/edit/'.$menu->id),'id'=>'addMenu','class'=>'form-horizontal','method'=>'post','novalidate'=>'novalidate'))
                    }}
                    <div class="control-group">
                        <label class="control-label">菜单名称</label>

                        <div class="controls">
                            {{Form::text('menu',$menu->menu,array('placeholder'=>'菜单名称'));}}
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            {{Form::text('menu_url',$menu->menu_url,array('placeholder'=>'菜单URL'));}}
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            ...
                            <label>
                                {{Form::radio('status','1', $menu->status=='1'?true:false);}}启用
                            </label>
                            <label>
                                {{Form::radio('status','0',$menu->status=='0'?true:false);}}禁用
                            </label>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $("#parent_id").select2('val',{{$menu->parent_id}});
