...
<div id="content-header">
    <div id="breadcrumb"><a href="{{URL::to('/')}}" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> 控制面板</a>
        <a href="{{URL::action('PictureController@getIndex')}}" class="current">设计管理</a><a href="{{URL::action('PictureController@getIndex')}}" class="tip-bottom">图库</a> </div>
</div>
            ...
            <div class="widget-box">
                ...
                <div class="widget-content tab-content">
                    <div class="widget-content nopadding">
                        <form class="form-horizontal" accept-charset="UTF-8" enctype="multipart/form-data" method="post" action="{{URL::action('PictureController@postUpload')}}" name="addPicture" id="addPicture" novalidate="novalidate">
