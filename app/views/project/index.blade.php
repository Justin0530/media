...
<div id="content-header">
    <div id="breadcrumb"><a href="index.html" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> 控制面板</a>
        <a href="#" class="tip-bottom">工程管理</a> <a href="#" class="current">点位信息</a></div>
    <!--    <h1>级别列表</h1>-->
</div>
<br />
<div class="container-fluid">
    ...
    <div class="row-fluid">
        <div class="span12">
            ...
            {{$kList->links();}}
            <p style="float: right;">
                <button id="confirm" class="btn btn-success"><i class="icon-ok"></i></i>  确认设备信息</button>
            </p>
    ...
    $(function () {
        $(":button[id='confirm']").click(function () {
            ...
            if ($.trim(checks) == ''||num>1) {
                ...
                location.href = "{{URL::to('/project/equipment')}}?kid=" + checks;
            }
        });
